...
--test ok
alter package pkg_no1 compile;

alter package pkg_no1 compile debug body;

alter package pkg_no1 compile debug specification reuse settings;

alter package pkg_no1 compile debug package PLSQL_CODE_TYPE=NATIVE reuse settings;
...
--failed
ALTER FUNCTION pkg_no1.test_mds compile;
...
alter package pg_myfirst compile;
alter package pg_myfirst compile body;
...
--ok
alter package test.test_pkg compile;
...
--test compile or replace change pg_proc argtypes
--and rettypes
...
ALTER function test_f compile;
ALTER PROCEDURE test_p compile;
ALTER PROCEDURE test_p1 compile;
