...
PG_KEYWORD("body", BODY, UNRESERVED_KEYWORD, BARE_LABEL) /* ReqID:SRS-SQL-PACKAGE */
...
PG_KEYWORD("packages", PACKAGES, UNRESERVED_KEYWORD, BARE_LABEL)	/* ReqID:SRS-SQL-PACKAGE */
...
PG_KEYWORD("specification", SPECIFICATION, UNRESERVED_KEYWORD, BARE_LABEL) /* ReqID:SRS-SQL-PACKAGE */
